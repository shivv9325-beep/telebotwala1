...
class UserAgentManager:
    """Manages rotating user agents for anti-detection"""
    ...
    def get_random(cls) -> str:
        all_agents = cls.DESKTOP_AGENTS + cls.MOBILE_AGENTS
        return random.choice(all_agents)
    
    @classmethod
    def get_headers(cls, agent_type: str = "desktop") -> Dict[str, str]:
        """Get full headers with user agent"""
        if agent_type == "mobile":
            ua = cls.get_random_mobile()
        else:
            ua = cls.get_random_desktop()
